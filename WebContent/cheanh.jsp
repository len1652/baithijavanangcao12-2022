...
<div style="TEXT-ALIGN: center;">
	     <h2 style="font-weight: 600;color: red;">Đăng ảnh chế</h2>
	  </div>
	    
   <div style="width: 600px;    margin: auto; margin-bottom: 100px;">
   	<form method="post" action="cheanhController?che=1" enctype= "multipart/form-data">
	    <div class="mb-3">
	      <label for="pwd">Tiêu đề ảnh:</label>
	    ...
	    float: right;">Đăng ảnh</button>
  </form>
  		<c:if test = "${ktra ==null}">
	         	<h4 style="color: red;"> Thông tin điền vào chưa đủ</h4>
	    </c:if>
   </div>
</body>
<script
