...
<div style="TEXT-ALIGN: center;">
	     <h2 style="font-weight: 600;color: red;">Đăng ký tài khoản</h2>
	  </div>
	    
   <div style="width: 600px;    margin: auto; margin-bottom: 100px;">
   	<form method="post" action="dangkyController">
	    <div class="mb-3">
	      <label for="pwd">Tên đăng nhập <label style="color: red;">*</label>:</label> 
	      <input type="text" class="form-control"  placeholder="" name="txttendangnhap">
	    </div>
	    <div class="mb-3">
	      <label for="pwd">Mật khẩu <label style="color: red;">*</label>:</label> 
	      <input type="password" class="form-control"  placeholder="" name="txtmatkhau">
	    </div>
	    <div class="mb-3 mt-3">
	      <label for="email">Tên người dùng           :</label> 
	      <input type="text" class="form-control"  placeholder="" name="txttennguoidung">
	    </div>
	    <div class="mb-3">
	      <label for="pwd">Email:</label>
	      <input type="email" class="form-control"  placeholder="" name="txtemail">
	    </div>
	    <div class="mb-3">
